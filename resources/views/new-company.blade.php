            ...
            @if(Session::has('success'))
                <div class="col-6">
                    <div class="alert alert-success" role="alert">
                        <span>New company <b>#{{Session::get('success')}}</b> has been added!</span>
                    </div>
                </div>
            @endif
            <div class="col-6">
                <form style="padding-bottom: 1rem" method="POST" action="{{route("company.store")}}" id="form" enctype="multipart/form-data" >
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="first_name" name="address">
                            </div>
                            <div class="col">
