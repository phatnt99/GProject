            ...
            @if(Session::has('success'))
                <div class="col-6">
                    <div class="alert alert-success" role="alert">
                        <span>New device <b>#{{Session::get('success')}}</b> has been added!</span>
                    </div>
                </div>
            @endif
            <div class="col-6">
                <form style="padding-bottom: 1rem" method="POST" action="{{route("device.store")}}" id="form" enctype="multipart/form-data" >
                    @csrf
